...
@Slf4j
public class CustomerConsumerV2 {
    ...
    public static void main(String[] args) {
        ...
        KafkaConsumer<Long, CustomerV2> customerConsumer = new KafkaConsumer<>(properties);
        ...
        try {
            ...
            while (true) {
                ConsumerRecords<Long, CustomerV2> consumerRecords = customerConsumer.poll(Duration.ofMillis(1000));
    ...
    private static void addShutdownHook(KafkaConsumer<Long, CustomerV2> customerConsumer) {
