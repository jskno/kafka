package com.github.alexwang.kafka.streams.windowing;

import com.github.alexwang.kafka.streams.serdes.JsonSerdes;
...
/**
 * The session window operation for website PV and UV analysis by real-time approach
 *
 * @see com.github.alexwang.kafka.streams.model.NetTraffic
 */
public class SessionTimeWindowApp {
    private final static Logger LOG = LoggerFactory.getLogger(SessionTimeWindowApp.class);
    private final static String APP_ID = "session_time_window_app";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        builder.stream(SOURCE_TOPIC, Consumed.with(Serdes.String(), JsonSerdes.NetTrafficSerde()).withName("source")
                ...
                .toStream()
                .foreach((k, v) -> LOG.info("The user:{} total visits {} times of website during {}-{}", k.key(), v, k.window().start(), k.window().end()));
