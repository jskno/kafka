 ...
 */
public class TumblingTimeWindowApp {
    private final static Logger LOG = LoggerFactory.getLogger(TumblingTimeWindowApp.class);
    private final static String APP_ID = "window_time_tumbling";
