...
public class StatefulOuterJoinOperation {
    private final static Logger LOG = LoggerFactory.getLogger(StatefulOuterJoinOperation.class);
    private final static String APP_ID = "stateful_outer_join_app";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ksUserWithKey.outerJoin(ksAddressWithKey, (left, right) -> left + "---" + right, JoinWindows.of(Duration.ofMinutes(1)),
