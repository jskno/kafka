...
public class H_SplitApp {

    private final static Logger LOGGER = LoggerFactory.getLogger(H_SplitApp.class);
    ...
    private static Properties buildStreamsProperties() {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "split-processor");
        return props;
    }
