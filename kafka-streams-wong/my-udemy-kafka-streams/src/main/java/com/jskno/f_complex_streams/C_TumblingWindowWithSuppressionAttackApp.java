...
public class C_TumblingWindowWithSuppressionAttackApp {

    private final static Logger LOGGER = LoggerFactory.getLogger(C_TumblingWindowWithSuppressionAttackApp.class);
    ...
    private static Properties buildStreamsProperties() {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "suppression-network-attack");
    ...
    private static Topology buildTopology() {
        ...
        sourceStream
                ...
                .count(Named.as("suppression-tumbling-count"), Materialized.as("suppression-tumbling-count-materialized"))
                .suppress(Suppressed.untilWindowCloses(Suppressed.BufferConfig.unbounded()))
                .filter((ip, count) -> count > 10)
                .toStream()
                .print(Printed.<Windowed<String>, Long>toSysOut().withLabel("suppression-attack"));
