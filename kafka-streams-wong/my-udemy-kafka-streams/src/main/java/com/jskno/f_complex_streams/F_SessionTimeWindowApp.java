...
public class F_SessionTimeWindowApp {

    private final static Logger LOGGER = LoggerFactory.getLogger(F_SessionTimeWindowApp.class);
    ...
    private static Properties buildStreamsProperties() {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "session-network");
    ...
    private static Topology buildTopology() {
        ...
        sourceStream
                ...
                .count(Named.as("session-count"), Materialized.as("session-count-materialized"))
                .suppress(Suppressed.untilWindowCloses(Suppressed.BufferConfig.unbounded()))
                .toStream()
                .foreach((k, v) -> LOGGER.info("The user:{} total visits {} times of website during {}-{}",
                        k.key(), v, k.window().start(), k.window().end()));
