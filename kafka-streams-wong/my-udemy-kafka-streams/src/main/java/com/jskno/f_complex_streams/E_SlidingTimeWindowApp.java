...
public class E_SlidingTimeWindowApp {

    private final static Logger LOGGER = LoggerFactory.getLogger(E_SlidingTimeWindowApp.class);
    ...
    private static Properties buildStreamsProperties() {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "sliding-network");
    ...
    private static Topology buildTopology() {
        ...
        sourceStream
                ...
                .count(Named.as("sliding-count"), Materialized.as("sliding-count-materialized"))
