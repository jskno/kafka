...
public class B1_Stateful_QueryableMultipleInstancesApp {

    private final static Logger LOGGER = LoggerFactory.getLogger(B1_Stateful_QueryableMultipleInstancesApp.class);

    public static void main(String[] args) throws InterruptedException {
        Properties props = buildStreamsProperties(args);
        Topology topology = buildTopology();

        KafkaStreams streams = new KafkaStreams(topology, props);

        new B0_QueryableStateStoreMultipleInstancesServer(streams, "sales-stats-query").start();
    ...
    private static Properties buildStreamsProperties(String[] args) {
