package com.jskno.i_globalktable;
...
public class CreateGlobalKTableApp {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        GlobalKTable<String, String> globalKTable = builder.globalTable(
                USER_ADDRESS_TOPIC,
        ...
        userInfoKS.join(globalKTable,
                        (k, v) -> k, (username, address) -> String.format("%s come from %s", username, address),
                        Named.as("join"))
