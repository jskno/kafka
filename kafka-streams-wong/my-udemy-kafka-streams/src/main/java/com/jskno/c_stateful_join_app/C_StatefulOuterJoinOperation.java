 ...
 */
public class C_StatefulOuterJoinOperation {

    private static final Logger logger = LoggerFactory.getLogger(C_StatefulOuterJoinOperation.class);
    ...
    private static Properties buildStreamsProperties() {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "outer-join-app");
    ...
    private static Topology buildTopology() {
        ...
        userInfoKeyed.outerJoin(userAddressKeyed, (left, right) -> left + "---" + right, JoinWindows.of(Duration.ofMinutes(1)),
                StreamJoined.with(Serdes.String(), Serdes.String(), Serdes.String()))
                .print(Printed.<String, String>toSysOut().withLabel("outer-join"));
