 ...
 */
public class A_StatefulInnerJoinOperation {

    private static final Logger logger = LoggerFactory.getLogger(A_StatefulInnerJoinOperation.class);
    ...
    private static Properties buildStreamsProperties() {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "inner-join-app");
    ...
    private static Topology buildTopology() {
        ...
        userInfoKeyed.join(userAddressKeyed, (left, right) -> left + "---" + right, JoinWindows.of(Duration.ofMinutes(1)),
