...
public class E_KStreamInnerJoinKTableApp {

    private final static Logger LOGGER = LoggerFactory.getLogger(E_KStreamInnerJoinKTableApp.class);
    ...
    private static Properties buildStreamsProperties() {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "kstream-join-ktable-operations");
    ...
    private static Topology buildTopology() {
        ...
        KTable<String, String> addressTable = builder.table(
                ...
                Consumed.with(Serdes.String(), Serdes.String())
                        ...
                        .withOffsetResetPolicy(Topology.AutoOffsetReset.LATEST),
                Materialized.as("address-materialized"));
        ...
        joinKStreamKTable.print(Printed.<String, String>toSysOut().withLabel("kstream-join-ktable"));
