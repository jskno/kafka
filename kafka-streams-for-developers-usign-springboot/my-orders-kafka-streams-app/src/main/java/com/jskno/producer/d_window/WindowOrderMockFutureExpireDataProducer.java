...
@Slf4j
public class WindowOrderMockFutureExpireDataProducer {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        var futureDateTime = OffsetDateTime.now().plusDays(1);
//        var pastDateTime = OffsetDateTime.now().minusDays(1);

        int count = 0;
        while (count < 10) {
            var orders = buildOrders(futureDateTime);
    ...
    private static List<Order> buildOrders(OffsetDateTime dateTime) {
