...
@Slf4j
public class OrderMockDataProducer_V1 {

    // Publish Messages ASync with flush and close
    ...
    private static List<ProducerRecord<String, Order>> buildOrderRecords() {
        ...
        return orders.stream()
            .map(order -> new ProducerRecord<>(OrderTopology.ORDERS, order.locationId(), order))
            .toList();
    }
