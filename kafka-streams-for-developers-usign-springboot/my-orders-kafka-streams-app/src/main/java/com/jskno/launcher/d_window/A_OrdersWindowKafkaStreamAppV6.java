...
import com.jskno.topology.d_ktable_window.A_OrderWindowTopologyV6;
...
@Slf4j
public class A_OrdersWindowKafkaStreamAppV6 {
    ...
    public static void main(String[] args) {
        ...
        Topology topology = A_OrderWindowTopologyV6.build();
