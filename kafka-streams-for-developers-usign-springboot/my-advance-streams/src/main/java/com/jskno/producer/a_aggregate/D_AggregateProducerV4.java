...
@Slf4j
public class D_AggregateProducerV4 {
    ...
    public static void main(String[] args) {
        ...
        var recordMetaData = publishMessageSync(D_ExploreAggregateOperatorTopologyV4.AGGREGATE, key, word);
        log.info("Published the alphabet message : {} ", recordMetaData);

        var recordMetaData1 = publishMessageSync(D_ExploreAggregateOperatorTopologyV4.AGGREGATE, key, word1);
        log.info("Published the alphabet message : {} ", recordMetaData1);

        var recordMetaData2 = publishMessageSync(D_ExploreAggregateOperatorTopologyV4.AGGREGATE, key, word2);
        ...
        var bWord1 = "Bus";
        var bWord2 = "Baby";
        var recordMetaData3 = publishMessageSync(D_ExploreAggregateOperatorTopologyV4.AGGREGATE, bKey, bWord1);
        log.info("Published the alphabet message : {} ", recordMetaData3);

        var recordMetaData4 = publishMessageSync(D_ExploreAggregateOperatorTopologyV4.AGGREGATE, bKey, bWord2);
