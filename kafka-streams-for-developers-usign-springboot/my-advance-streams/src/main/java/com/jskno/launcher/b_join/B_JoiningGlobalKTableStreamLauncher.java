...
import com.jskno.topology.b_join.B_ExploreKStreamJoinGlobalKTableTopology;
...
@Slf4j
public class B_JoiningGlobalKTableStreamLauncher {
    ...
    public static void main(String[] args) {
        ...
        Topology kTableTopology = B_ExploreKStreamJoinGlobalKTableTopology.build();
