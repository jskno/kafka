...
import com.jskno.topology.b_join.D_ExploreKStreamJoinKStreamTopology;
...
@Slf4j
public class D_JoiningKStreamKStreamLauncher {
    ...
    public static void main(String[] args) {
        ...
        Topology kTableTopology = D_ExploreKStreamJoinKStreamTopology.build();
