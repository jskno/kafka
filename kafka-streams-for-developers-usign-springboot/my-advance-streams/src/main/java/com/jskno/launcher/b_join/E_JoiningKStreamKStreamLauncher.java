...
import com.jskno.topology.b_join.E_ExploreKStreamLeftJoinKStreamTopology;
...
@Slf4j
public class E_JoiningKStreamKStreamLauncher {
    ...
    public static void main(String[] args) {
        ...
        createTopics(streamProperties,
            List.of(
                E_ExploreKStreamLeftJoinKStreamTopology.ALPHABETS,
                E_ExploreKStreamLeftJoinKStreamTopology.ALPHABETS_ABBREVIATIONS));

        Topology kTableTopology = E_ExploreKStreamLeftJoinKStreamTopology.build();
