...
@Slf4j
public class C_HopingWindowStreamLauncher {

    private static AdminClient adminClient;

    public static void main(String[] args) {
        Properties properties = buildStreamProperties();
        createTopics(properties, List.of(C_ExploreHopingWindowTopology.WINDOW_WORDS));

        var topology = C_ExploreHopingWindowTopology.build();
