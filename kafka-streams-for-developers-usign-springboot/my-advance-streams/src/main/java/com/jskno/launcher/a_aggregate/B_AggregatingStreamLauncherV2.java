...
@Slf4j
public class B_AggregatingStreamLauncherV2 {

    public static void main(String[] args) {
        Properties properties = buildProperties();
        createTopics(properties, List.of(B_ExploreCountOperatorTopologyV2.AGGREGATE));

        Topology kTableTopoligy = B_ExploreCountOperatorTopologyV2.build();
