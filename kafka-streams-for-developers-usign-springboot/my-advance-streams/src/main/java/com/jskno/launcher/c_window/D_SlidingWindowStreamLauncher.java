...
import com.jskno.topology.c_window.C_ExploreHopingWindowTopology;
import com.jskno.topology.c_window.D_ExploreSlidingWindowTopology;
...
@Slf4j
public class D_SlidingWindowStreamLauncher {

    private static AdminClient adminClient;

    public static void main(String[] args) {
        Properties properties = buildStreamProperties();
        createTopics(properties, List.of(D_ExploreSlidingWindowTopology.WINDOW_WORDS));

        var topology = D_ExploreSlidingWindowTopology.build();
