...
@Slf4j
public class A_AggregatingStreamLauncher {

    public static void main(String[] args) {
        Properties properties = buildProperties();
        createTopics(properties, List.of(A_ExploreCountOperatorTopology.AGGREGATE));

        Topology kTableTopoligy = A_ExploreCountOperatorTopology.build();
