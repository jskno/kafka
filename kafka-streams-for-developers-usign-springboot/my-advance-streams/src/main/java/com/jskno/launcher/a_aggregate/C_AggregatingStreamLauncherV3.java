...
@Slf4j
public class C_AggregatingStreamLauncherV3 {

    public static void main(String[] args) {
        Properties properties = buildProperties();
        createTopics(properties, List.of(C_ExploreReduceOperatorTopologyV3.AGGREGATE));

        Topology kTableTopoligy = C_ExploreReduceOperatorTopologyV3.build();
