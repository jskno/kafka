...
public class F_ExploreKStreamOuterJoinKStreamTopology {
    ...
    private static void joinKStreamWithKStream(StreamsBuilder streamsBuilder) {
        ...
        var joinedStream = alphabetsAbbreviationStream.outerJoin(alphabetsStream, valueJoiner, joinWindows, joinedParams);
