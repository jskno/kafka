...
public class E_ExploreKStreamLeftJoinKStreamTopology {
    ...
    private static void joinKStreamWithKStream(StreamsBuilder streamsBuilder) {
        ...
        var joinedStream = alphabetsAbbreviationStream.leftJoin(alphabetsStream, valueJoiner, joinWindows, joinedParams);
