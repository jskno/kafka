...
public class G_ExploreKStreamJoinKStreamDifferentPartitionsTopology {

    public static final String ALPHABETS = "k-alphabets"; // A => First letter in the english alphabet
    public static final String ALPHABETS_ABBREVIATIONS = "k-alphabets-abbreviations"; // A => Apple
    ...
    private static void joinKStreamWithKStream(StreamsBuilder streamsBuilder) {
        ...
        StreamJoined<String, String, String> joinedParams = StreamJoined.with(
            ...
            .withName("my-simple-inner")
            .withStoreName("my-simple-inner");
