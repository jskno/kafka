...
import static com.jskno.management.orders.streams.constants.OrdersConstants.STORES;
...
import com.jskno.management.orders.domain.store.Address;
        ...
        stores
                .forEach(store -> {
                    try {
                        ...
                        var recordMetaData = publishMessageSync(STORES, store.locationId(), storeJSON);
