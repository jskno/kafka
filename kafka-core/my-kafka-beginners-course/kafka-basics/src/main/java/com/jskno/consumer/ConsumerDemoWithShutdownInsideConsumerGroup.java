...
public class ConsumerDemoWithShutdownInsideConsumerGroup {

    private static final Logger log = LoggerFactory.getLogger(ConsumerDemoWithShutdownInsideConsumerGroup.class.getSimpleName());
