...
public class ProducerDemoWithCallbackLoopForceSleep {

    public static final Logger log = LoggerFactory.getLogger(ProducerDemoWithCallbackLoopForceSleep.class.getSimpleName());
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            ProducerRecord<String, String> producerRecord = new ProducerRecord<>("demo_java", "record" + i);
