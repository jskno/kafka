...
public class OpenSearchConsumer_B_IdemPotent {

    private final static Logger log = LoggerFactory.getLogger(OpenSearchConsumer_B_IdemPotent.class.getSimpleName());
