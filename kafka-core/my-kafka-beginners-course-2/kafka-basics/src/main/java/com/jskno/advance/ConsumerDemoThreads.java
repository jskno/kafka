...
public class ConsumerDemoThreads {
    ...
    private static class ConsumerDemoWorker implements Runnable {
        ...
        public void run() {
            ...
            consumer.subscribe(Collections.singleton("demo-java"));
            ...
            try {
                while (true) {
                    ...
                    for (final ConsumerRecord<String, String> consumerRecord : consumerRecords) {
                        log.info("Getting consumer record key: '" + consumerRecord.key() + "', value: '" + consumerRecord.value() +
                            "', partition: " + consumerRecord.partition() + " and offset: " + consumerRecord.offset() + " at " +
