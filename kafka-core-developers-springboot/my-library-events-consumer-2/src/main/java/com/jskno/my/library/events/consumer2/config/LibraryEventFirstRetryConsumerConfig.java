...
@Configuration
@Slf4j
public class LibraryEventFirstRetryConsumerConfig {

    @Value("${library.events.kafka.second.retry.topic}")
    ...
    @Bean("kafkaListenerContainerFactoryForFirstRetry")
...
//            // Custom error handling logic for listener2
//            System.err.println("ErrorHandler2: " + exception.getMessage());
//            return null;
//        };
//    }
