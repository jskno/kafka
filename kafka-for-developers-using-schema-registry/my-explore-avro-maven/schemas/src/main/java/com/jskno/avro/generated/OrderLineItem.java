...
public class OrderLineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3450704573783063225L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderLineItem\",\"namespace\":\"com.jskno.avro.generated\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"size\",\"type\":{\"type\":\"enum\",\"name\":\"Size\",\"symbols\":[\"SMALL\",\"MEDIUM\",\"LARGE\"]}},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"cost\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":3,\"scale\":2}}]}");
...
static {
  ...
  @Deprecated public com.jskno.avro.generated.Size size;
   ...
   */
  public OrderLineItem(java.lang.CharSequence name, com.jskno.avro.generated.Size size, java.lang.Integer quantity, java.math.BigDecimal cost) {
    this.name = name;
    this.size = size;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: size = (com.jskno.avro.generated.Size)value$; break;
   ...
   */
  public com.jskno.avro.generated.Size getSize() {
    return size;
  }
   ...
   * @param value the value to set.
   */
  public void setSize(com.jskno.avro.generated.Size value) {
    this.size = value;
  }
   ...
   */
  public static com.jskno.avro.generated.OrderLineItem.Builder newBuilder() {
    return new com.jskno.avro.generated.OrderLineItem.Builder();
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static com.jskno.avro.generated.OrderLineItem.Builder newBuilder(com.jskno.avro.generated.OrderLineItem.Builder other) {
    if (other == null) {
      return new com.jskno.avro.generated.OrderLineItem.Builder();
    } else {
      return new com.jskno.avro.generated.OrderLineItem.Builder(other);
    }
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static com.jskno.avro.generated.OrderLineItem.Builder newBuilder(com.jskno.avro.generated.OrderLineItem other) {
    if (other == null) {
      return new com.jskno.avro.generated.OrderLineItem.Builder();
    } else {
      return new com.jskno.avro.generated.OrderLineItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderLineItem>
    ...
    private com.jskno.avro.generated.Size size;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.jskno.avro.generated.OrderLineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.jskno.avro.generated.OrderLineItem other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jskno.avro.generated.OrderLineItem.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jskno.avro.generated.OrderLineItem.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jskno.avro.generated.OrderLineItem.Builder setSize(com.jskno.avro.generated.Size value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jskno.avro.generated.OrderLineItem.Builder clearSize() {
      size = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jskno.avro.generated.OrderLineItem.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jskno.avro.generated.OrderLineItem.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jskno.avro.generated.OrderLineItem.Builder setCost(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jskno.avro.generated.OrderLineItem.Builder clearCost() {
      cost = null;
    ...
    public OrderLineItem build() {
      try {
        ...
        record.size = fieldSetFlags()[1] ? this.size : (com.jskno.avro.generated.Size) defaultValue(fields()[1]);
