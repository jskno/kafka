...
public class GreetingOld extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1994150627907568642L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"GreetingOld\",\"namespace\":\"com.jskno.avro\",\"fields\":[{\"name\":\"greeting\",\"type\":\"string\"}]}");
   ...
   */
  public static com.jskno.avro.GreetingOld.Builder newBuilder() {
    return new com.jskno.avro.GreetingOld.Builder();
  }
   ...
   * @return A new GreetingOld RecordBuilder
   */
  public static com.jskno.avro.GreetingOld.Builder newBuilder(com.jskno.avro.GreetingOld.Builder other) {
    if (other == null) {
      return new com.jskno.avro.GreetingOld.Builder();
    } else {
      return new com.jskno.avro.GreetingOld.Builder(other);
    }
  }
   ...
   * @return A new GreetingOld RecordBuilder
   */
  public static com.jskno.avro.GreetingOld.Builder newBuilder(com.jskno.avro.GreetingOld other) {
    if (other == null) {
      return new com.jskno.avro.GreetingOld.Builder();
    } else {
      return new com.jskno.avro.GreetingOld.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GreetingOld>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.jskno.avro.GreetingOld.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.jskno.avro.GreetingOld other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.greeting)) {
        this.greeting = data().deepCopy(fields()[0].schema(), other.greeting);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jskno.avro.GreetingOld.Builder setGreeting(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jskno.avro.GreetingOld.Builder clearGreeting() {
      greeting = null;
