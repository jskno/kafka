...
public class OrderId extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1419308855980145548L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderId\",\"namespace\":\"com.jskno.avro.generated\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"}]}");
   ...
   */
  public OrderId(java.lang.Long id) {
    this.id = id;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderId>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jskno.avro.generated.OrderId.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jskno.avro.generated.OrderId.Builder clearId() {
